...
def database_list(page: ft.Page):
    ...
    def create_new_key(database):
        ...
        text_field_2 = ft.TextField(
            label="Value", on_submit=lambda e: create_new_key_submit(e)
        )
        page.add(text_field)
    ...
    def get_all(database):
        ...
        my_table_2.rows = [
            ft.DataRow(
                cells=[
                    ...
                    ft.DataCell(
                        ft.Text("Delete"), on_tap=lambda e: delete_key(database, key)
                    ),
                ],
            )
        ...
        my_table_2.rows.append(
            ft.DataRow(
                cells=[
                    ft.DataCell(
                        ft.Text("Create or Edit Key"),
                        on_tap=lambda e: create_new_key(database),
                    ),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
                ],
        ...
        page.show_snack_bar(ft.SnackBar(ft.Text("Database list updated"), open=True))
        page.update()
    ...
    def rename_database(old_name):
        ...
        text_field = ft.TextField(
            label="New Name", on_submit=lambda e: rename_database_submit(e)
        )
        page.add(text_field)
    ...
    def create_new_db():
        ...
        text_field = ft.TextField(
            label="New DB Name", on_submit=lambda e: create_new_db_submit(e)
        )
        page.add(text_field)
    ...
    def fab_pressed(e):
            ...
            ft.DataRow(
                cells=[
                    ft.DataCell(
                        ...
                        on_long_press=lambda e, database=database: rename_database(
                            database
                        ),
                    ),
                    ...
                    ft.DataCell(
                        ft.Text("Delete"),
                        on_tap=lambda e, database=database: delete_database(database),
                    ),
                    ft.DataCell(
                        ft.Text("Pop"),
                        on_tap=lambda e, database=database: pop_database(database),
                    ),
                ],
            )
        ...
        my_table.rows.append(
            ft.DataRow(
                cells=[
                    ft.DataCell(
                        ft.Text("Create New Database"), on_tap=lambda e: create_new_db()
                    ),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
        ...
        my_table.rows.append(
            ft.DataRow(
                cells=[
                    ft.DataCell(
                        ft.Text("Delete All Databases"),
                        on_tap=lambda e: delete_database_all(),
                    ),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
        ...
        my_table.rows.append(
            ft.DataRow(
                cells=[
                    ft.DataCell(
                        ft.Text("Pop All Databases"),
                        on_tap=lambda e: pop_database_all(),
                    ),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
                    ft.DataCell(ft.Text("")),
...
def login(
    ...
    def login_submit(e):
        if password == text_field.value:
            page.show_snack_bar(ft.SnackBar(ft.Text("Login successful"), open=True))
            page.remove(text_field)
            database_list(page)
